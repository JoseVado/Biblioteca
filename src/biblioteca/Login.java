...
public class Login extends javax.swing.JFrame {
    ...
    private final String buscarEmpleado = "empleados";
    private final String compararAdmin = "Administrador";
    private final int columnaContra = 7;
    private final int columnaTrabajo = 5;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biblioteca/images/Bibliophile.gif"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biblioteca/images/library (1).png"))); // NOI18N
        ...
        usuariotxt.setBackground(new java.awt.Color(153, 51, 0));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biblioteca/images/icons8_user_20px_1.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biblioteca/images/bloquear.png"))); // NOI18N
        ...
        contrapwf.setBackground(new java.awt.Color(153, 51, 0));
        ...
        panelEntrar.setBackground(new java.awt.Color(102, 51, 0));
        ...
        disable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biblioteca/images/icons8_invisible_20px_1.png"))); // NOI18N
        ...
        show.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biblioteca/images/icons8_eye_20px_1.png"))); // NOI18N
        ...
        jLabel8.setText("Hola, de nuevo ¿Qué aprenderemos hoy?");
    ...
    private void txtEntrarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtEntrarMouseEntered
        panelEntrar.setBackground(new Color(204,102,0));
    ...
    private void txtEntrarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtEntrarMouseExited
        panelEntrar.setBackground(new Color(102,51,0));
    ...
    private boolean esUsuario(String usuario, char[] contra){
        try {
            String[][] datosUsuario = ComunicacionBD.datosBD(buscarEmpleado, "usuario", usuario);
            if(datosUsuario.length != 1){
                JOptionPane.showMessageDialog(this, "Usuario o contraseña invalidos.");
                return false;
            }
            
            if( !Arrays.equals(datosUsuario[0][columnaContra].toCharArray(), contra) ){
                JOptionPane.showMessageDialog(this, "Usuario o contraseña invalidos.");
                return false;
            }
            
            if(datosUsuario[0][columnaTrabajo].equals(compararAdmin)){
                esAdmin = true;
            }
        ...
        return true; //Cambiar para conectarlo a la bd
    }
